      ...
      <div className="px-4 md:px-12 py-3 sticky top-[68px] z-[99999]" style={{ background: `rgba(20, 20, 20, ${searchOpacity})` }}>
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <p className='text-xs mt-1'>
            ...
            <a href="https://www.linkedin.com/in/amalendu-guru-5a8009227/" target="_blank" rel="noreferrer" className='ml-2 text-sm text-gray-400 hover:text-gray-200'>Request now</a>
          </p>
        </form>
      </div>
    </>
