  ...
  return (
    <div className="about-us mt-[70px] px-4 md:px-24">
      ...
      <p className="text-gray-400 mb-8 text-center">
        "Experience CinemaGPT: A Feature-Rich, Mobile-Friendly Clone with
        Cutting-Edge Tech Stack! 🚀
        <br />
        <br />
        Dive into the world of CinemaGPT, a carefully crafted clone that boasts
        an impressive tech stack including React, Redux, Webpack, React Router,
        TMDB APIs, Tailwind CSS, Firebase, React-DOM, and Jest. The result? An
        exceptional web application designed for optimal performance and
        seamless user interactions. CinemaGPT is fully optimized to ensure
        lightning-fast load times and a smooth user experience, making it
        perfect for both desktop and mobile devices. Discover a user-friendly
        ...
        user-centric design converge to create CinemaGPT-a showcase of what's
      ...
      <div className="mb-8 text-gray-200">
        Github:{" "}
        <a
          href="https://github.com/AmalenduGuru01"
        ...
        Linkedin:{" "}
        <a
          href="https://www.linkedin.com/in/amalendu-guru-5a8009227/"
          className="hover:text-blue-700 ml-3 text-blue-600 text-sm"
          target="_blank"
          rel="noreferrer"
        >
